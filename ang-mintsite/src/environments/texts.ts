...
export const texts = {
  ...
  splash_mint_description_2:"Allowlist and whitelist only. One NFT per wallet.",
  ...
  status_switch_error:"Network switch failed, try again",
    ...
    generate_paused_note:"This Avatizer will not update itself. Its current art will remain unchanged until you enable Daily Reloads."
